...
<figure id="Figure0">
  ...
  <figcaption align="center">
    <strong>Figure 0:</strong> Incomplete longitudinal trajectories of pre- and post-vaccination HAI titers collected from 30 randomly selected participants over eleven years..
  </figcaption>
</figure>
...
<figure id="Figure1">
  ...
  <figcaption>
 <strong>Figure 1:</strong> Two-dimensional surfaces. The four panels from left to right show the true smooth surface g(x, z) = sin(0.1x) cos(0.1z) + 0.001xz, and its approximations using the recovered GMRF G<sub>0</sub from  JMDF-GMRF<sub>m</sub> for m = 1, 2, 3.
  </figcaption>
</figure>
